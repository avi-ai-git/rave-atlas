...
if __name__ == "__main__":
    ...
    print("=" * 60)
    provider = _provider_for("anthropic/claude-sonnet-4-6")
    print(f"  anthropic/claude-sonnet-4-6 → provider: {provider}")
    assert provider == "openrouter", "FAIL: Claude model should route to openrouter"
    provider2 = _provider_for("gemma3:27b")
    print(f"  gemma3:27b                  → provider: {provider2}")
    assert provider2 == "ollama", "FAIL: Gemma model should route to ollama"
