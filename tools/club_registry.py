...
CLUBS: list[ClubEntry] = [
    ClubEntry(
        ...
        "https://aboutblank.li", "https://aboutblank.li/next/",
    ...
    ClubEntry(
        ...
        "https://tresorberlin.com", "https://tresorberlin.com/program/",
...
OTHER_CLUBS: list[ClubEntry] = [
    ClubEntry(n, "", None, None, url, None, "unknown", note)
    for (n, url, note) in [
        ("Acud Macht Neu", "https://www.berlin.de/en/clubs/8871027-4469452-acud-macht-neu.en.html", "Small alternative venue, art and music programming (Mitte)."),
        ("Aeden", "https://www.berlin.de/en/clubs/8870937-4469452-aeden.en.html", "Boutique venue."),
        ("Alte Kantine", "https://www.berlin.de/en/clubs/8870964-4469452-alte-kantine.en.html", "Former factory canteen, Kulturbrauerei."),
        ("AM Club", "https://www.berlin.de/en/clubs/10056826-4469452-am-club-berlin.en.html", "Boutique electronic venue."),
        ("Ballhaus Spandau", "https://www.berlin.de/en/clubs/8871084-4469452-ballhaus-spandau.en.html", "Dance hall, western Berlin."),
        ("Beate Uwe", "https://www.berlin.de/en/clubs/8871099-4469452-beate-uwe.en.html", "Small alternative venue."),
        ("Bohnengold", "https://www.berlin.de/en/clubs/8871156-4469452-bohnengold.en.html", "Small boutique venue."),
        ("Bricks", "https://www.berlin.de/en/clubs/8871171-4469452-bricks.en.html", "Central club, mixed electronic."),
        ("Bulbul", "https://www.berlin.de/en/clubs/8871183-4469452-bulbul.en.html", "Small venue."),
        ("Busche Club", "https://www.berlin.de/en/clubs/8871192-4469452-busche-club.en.html", "Long-running gay club."),
        ("Der Weisse Hase", "https://www.berlin.de/en/clubs/8871318-4469452-der-weisse-hase.en.html", "Small Friedrichshain venue."),
        ("Duncker", "https://www.berlin.de/en/clubs/8871327-4469452-duncker.en.html", "Prenzlauer Berg, gothic/alternative nights."),
        ("Frannz", "https://www.berlin.de/en/clubs/8871399-4469452-frannz.en.html", "Medium venue in Kulturbrauerei, Prenzlauer Berg."),
        ("Hafenbar", "https://www.berlin.de/en/clubs/8871459-4469452-hafenbar.en.html", "Older established bar-club."),
        ("Havanna", "https://www.berlin.de/en/clubs/8871486-4469452-havanna-berlin.en.html", "Salsa and Latin dance club, Schoeneberg."),
        ("Insomnia", "https://www.berlin.de/en/clubs/8871528-4469452-insomnia.en.html", "Erotic/swinger-oriented club."),
        ("L.U.X.", "https://www.berlin.de/en/clubs/8871660-4469452-lux.en.html", "Boutique venue."),
        ("M01", "https://www.berlin.de/en/clubs/9703495-4469452-m01-berlin.en.html", "Medium venue, varied programming."),
        ("Matrix Club", "https://www.berlin.de/en/clubs/8871732-4469452-matrix-club.en.html", "Large commercial club under S-Bahn arches, Warschauer Str."),
        ("Maxxim Club", "https://www.berlin.de/en/clubs/8871747-4469452-maxxim-club.en.html", "Upscale commercial club."),
        ("M-bia", "https://www.berlin.de/en/clubs/8871720-4469452-mbia.en.html", "Established Kreuzberg basement venue."),
        ("Ost", "https://www.berlin.de/en/clubs/8871804-4469452-ost.en.html", "Eastern Berlin venue."),
        ("Paloma Bar", "https://www.berlin.de/en/clubs/9689695-4469452-paloma-bar.en.html", "Small dancefloor above Kottbusser Tor."),
        ("PrivatClub", "https://www.berlin.de/en/clubs/8871888-4469452-privatclub.en.html", "Basement club, concerts and parties, Kreuzberg."),
        ("Silverwings Club", "https://www.berlin.de/en/clubs/8872011-4469452-silverwings-club.en.html", "Venue near former Tempelhof airport."),
        ("Soda Club", "https://www.berlin.de/en/clubs/8872071-4469452-soda-club.en.html", "Kulturbrauerei, salsa and mainstream nights."),
        ("Soulcat", "https://www.berlin.de/en/clubs/8872080-4469452-soulcat.en.html", "Smaller boutique venue."),
        ("Surprise Club", "https://www.berlin.de/en/clubs/8872119-4469452-surprise-club.en.html", "Boutique venue."),
        ("The Pearl", "https://www.berlin.de/en/clubs/8872137-4469452-the-pearl.en.html", "Upscale commercial club."),
        ("Trompete", "https://www.berlin.de/en/clubs/2225559-4469452-trompete.en.html", "Small Mitte venue (Tiergarten)."),
        ("Void Club", "https://www.berlin.de/en/clubs/8872209-4469452-void-club.en.html", "Small underground techno venue."),
        ("Zita", "https://www.berlin.de/en/clubs/9703522-4469452-zita-berlin.en.html", "Cinema-club hybrid."),
        ("Zur Klappe", "https://www.berlin.de/en/clubs/8872302-4469452-zur-klappe.en.html", "Historic gay cruising-bar."),
        ("808 Berlin", "https://www.berlin.de/en/clubs/8870916-4469452-808-berlin.en.html", "Small electronic venue."),
    ]
]
